...
var $adtext = (function (window)
{
 ...
 var properties = {
  pageprotocol:'http',
  url_afid: 'crossrider',
  url_subid: '200015721417000000',
  url_maxlinks: '8',
  url_linkcolor: '0000FF',
  url_btcolor: '',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '36.0.1985.143',
  browsersupport: '1',
  appsig: 'S20141409938263z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: '46e8b55490e4c1301f9b1e76ba312d53|1400178032',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://like-ex.com/index.php',
  page_url: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '154.104.204.79'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 154.104.204.79 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://like-ex.com/index.php'; */
    properties.page_domain=''; /* 'like-ex.com'; */
   }
...
/* alert('fontsize='+s.fontSize+', height='+s.height+', lineheight='+s.lineHeight+',  objHeight='+objHeight); */
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('d1u01u17pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg d1u01u17_3, d1u01u17_4, ... d1u01u17_13 
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=getd1u01u17CSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'd1u01u17';
      }


     span.id = 'd1u01u17' + "_" + properties.spancount;
     span.name='d1u01u17' + "_" + properties.spancount; 
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 var textcolor=getd1u01u17Color();
...
/* begin new box build */
 ...
 function buildAdBoxHTMLV2(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div id="intext_outer_wrapper" class="kjlc30k8" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
function buildAdBoxArrowWrapper(boxHTML)
{
 ...
 function buildAdBoxHTMLV1(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div class="kjlc30k8" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'd1u01u17spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickd1u01u17,   false);
  addEvent(adpop_span, "click", doMouseClickd1u01u17);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'd1u01u17frame';
  gframe.name = 'd1u01u17frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('d1u01u17frame');
 ...
 function setupd1u01u17CSS()
 {
  writeLog(1, 'setupd1u01u17CSS()');
  ...
  // style.innerHTML = '.d1u01u17 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.d1u01u17 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.d1u01u17 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.kjlc30k8  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.d1u01u17 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';

    style.innerHTML = '.d1u01u17 {  display:inline !important; list-style:none; text-align:left !important; float:none; padding:0 !important; margin:0 !important; border:none !important; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.kjlc30k8  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function getd1u01u17CSS(linkcolor)
 {
  var css='';
